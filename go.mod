...
require (
	...
	gitlab.com/bersufekadgetachew/cbe-super-app-shared v0.1.93
...
require github.com/aws/aws-sdk-go-v2/feature/s3/manager v1.20.18 // indirect
...
require (
	...
	// ✅ pin split genproto modules ONLY
