		...
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.expectedError != nil {
				...
				for i := range tt.expectedResult.Customers {
					...
					assert.Equal(t, tt.expectedResult.Customers[i].BranchCode, result.Customers[i].BranchCode)
					assert.Equal(t, tt.expectedResult.Customers[i].BranchName, result.Customers[i].BranchName)
