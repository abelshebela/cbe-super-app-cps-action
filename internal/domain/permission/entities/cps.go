...
type CPSAction struct {
	...
	PreviousAction     struct{}      `bson:"previous_action" json:"previous_action"`
	...
	CheckerActionTime  *time.Time    `bson:"checker_action_time,omitempty" json:"checker_action_time,omitempty"`
}
