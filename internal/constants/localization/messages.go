...
const (
	...
	MsgRoleDelegationDataExportedSuccess   = "Role delegation data exported successfully"
	MsgRoleDelegationDataExportFailed      = "Role delegation data export failed"
	MsgRoleDelegationDataNotFoundInRange   = "No role delegation data found in the specified date range"
	MsgCpsUserDataExportedSuccessfully     = "CPS users data exported successfully"
	MsgCpsUserDataExportFailed             = "CPS users data export failed"
	MsgCpsUserDataNotFoundInDateRange      = "No CPS users data found in the specified date range"
	MsgBpsUserDataExportedSuccessfully     = "BPS users data exported successfully"
	MsgBpsUserDataExportFailed             = "BPS users data export failed"
	MsgBpsUserDataNotFoundInDateRange      = "No BPS users data found in the specified date range"
	...
	MsgCustomerBlockedSuccessfulySP          = "Customer successfully blocked"
	MsgCustomerBlockRequestSentSuccessfuly   = "Customer blocked request sent successfuly"
	MsgCustomerUnBlockedSuccessfulySP        = "Customer is unblocked successfully"
	MsgCustomerUnBlockRequestSentSuccessfuly = "Customer unblocked request sent successfuly"
...
const (
	...
	// Account Product Category messages
	MsgAPCCreateRequestSent  = "Account product category create request sent successfully"
	MsgAPCCreated            = "Account product category created successfully"
	MsgAPCUpdateRequestSent  = "Account product category update request sent successfully"
	MsgAPCUpdated            = "Account product category updated successfully"
	MsgAPCDeleteRequestSent  = "Account product category delete request sent successfully"
	MsgAPCDeleted            = "Account product category deleted successfully"
	MsgAPCEnableRequestSent  = "Account product category enable request sent successfully"
	MsgAPCEnabled            = "Account product category enabled successfully"
	MsgAPCDisableRequestSent = "Account product category disable request sent successfully"
	MsgAPCDisabled           = "Account product category disabled successfully"
	MsgAPCsRetrieved         = "Account product categories retrieved successfully"
	MsgAPCRetrieved          = "Account product category retrieved successfully"
	MsgAPCNotFound           = "Account product category not found"
	...
	MsgAPCreated            = "Account product created successfully"
	MsgAPUpdateRequestSent  = "Account product update request sent successfully"
	MsgAPUpdated            = "Account product updated successfully"
	MsgAPDeleteRequestSent  = "Account product delete request sent successfully"
	MsgAPDeleted            = "Account product deleted successfully"
	MsgAPEnableRequestSent  = "Account product enable request sent successfully"
	MsgAPEnabled            = "Account product enabled successfully"
	MsgAPDisableRequestSent = "Account product disable request sent successfully"
	MsgAPDisabled           = "Account product disabled successfully"
	MsgAPsRetrieved         = "Account products retrieved successfully"
	MsgAPRetrieved          = "Account product retrieved successfully"
	MsgAPNotFound           = "Account product not found"
