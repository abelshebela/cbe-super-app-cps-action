...
const (
	...
	MsgRoleCreatedRequestSent     = "Role created request sent successfully"
	MsgRoleUpdatedRequestSent     = "Role updated request sent successfully"
	...
	MsgRoleCreatedSP              = "Role created successfully"
	MsgRoleUpdatedSP              = "Role updated successfully"
	...
	MsgCpsActionDataExportFailed           = "CPS actions Data export failed"
	...
	MsgJobRoleAlreadyDisenabled     = "Job role already disenabled"
...
const (
	...
	MsgCodeIsRequired                    = "code is required"
	...
	MsgEventMerchantInvalidIsEventMerchant         = "merchant type is not allowed, must be event merchant"
	MsgEcommerceMerchantInvalidIsEcommerceMerchant = "merchant type is not allowed, must be ecommerce merchant"
	...
	MsgLogisticMerchantInvalidIsLogisticsMerchant = "merchant type is not allowed, must be logistic merchant"
	...
	MsgServiceDeletedSuccessfullySp                  = "Service deleted successfully"
	MsgServiceDeletedSuccessfully                    = "Service delete request submited successfully"
	...
	MsgAccountSubTypeCreated            = "Account sub type created successfully"
	MsgAccountSubTypeUpdateRequestSent  = "Account sub type update request sent successfully"
	MsgAccountSubTypeUpdated            = "Account sub type updated successfully"
	MsgAccountSubTypeDeleteRequestSent  = "Account sub type delete request sent successfully"
	MsgAccountSubTypeEnableRequestSent  = "Account sub type enable request sent successfully"
	MsgAccountSubTypeEnabled            = "Account sub type enabled successfully"
	MsgAccountSubTypeDisableRequestSent = "Account sub type disable request sent successfully"
	MsgAccountSubTypeDisabled           = "Account sub type disabled successfully"
	MsgAccountSubTypesRetrieved         = "Account sub types retrieved successfully"
	MsgAccountSubTypeRetrieved          = "Account sub type retrieved successfully"
	MsgAccountSubTypeNotFound           = "Account sub type not found"
	MsgAccountSubTypeAlreadyEnabled     = "Account sub type is already enabled"
	MsgAccountSubTypeAlreadyDisabled    = "Account sub type is already disabled"
	MsgAccountSubTypeCodeAlreadyExists  = "Account sub type code already exists"
	MsgAccountSubTypeNameAlreadyExists  = "Account sub type name already exists"
	MsgAccountSubTypeNameRequired       = "Account sub type name is required"
	MsgAccountSubTypeCodeRequired       = "Account sub type code is required"
	MsgAccountSubTypeNameSpecialChar    = "Account sub type name must not contain special characters"
	MsgAccountSubTypeCodeSpecialChar    = "Account sub type code must not contain special characters"
	MsgAccountSubTypeAccountTypeReq     = "Account type is required"
	MsgAccountSubTypeInvalidAccountType = "Account type must be one of: IFB, CB"
	MsgAccountSubTypeGenderRequired     = "Gender is required"
	MsgAccountSubTypeInvalidGender      = "Gender must be one of: MALE, FEMALE, OTHER"
)
