...
var ErrorMap = map[error]int{
	...
	ErrHealthCheckFailed:            http.StatusInternalServerError,
	ErrSessionRetrivalFailed:        http.StatusInternalServerError,
	ErrSessionUpdateFailed:          http.StatusInternalServerError,
	ErrSessionCreationFailed:        http.StatusInternalServerError,
	ErrPhoneLookUpFailed:            http.StatusInternalServerError,
	ErrProfileSet:                   http.StatusInternalServerError,
	ErrApiRequestFailed:             http.StatusInternalServerError,
