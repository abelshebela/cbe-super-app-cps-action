...
func (u *user) Register(w http.ResponseWriter, r *http.Request) {
	...
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		u.logger.Error(r.Context(), "failed to decode register request", zap.Error(err))
	...
	if err := req.Validate(); err != nil {
		u.logger.Error(r.Context(), "invalid input provided to register request", zap.Error(err))
...
func (u *user) VerifyOtp(w http.ResponseWriter, r *http.Request) {
	...
	if err := req.Validate(); err != nil {
		u.logger.Error(r.Context(), "invalid input provided to verify otp request", zap.Error(err))
		response.SendErrorResponse(w, err)
		return
	}
...
func (u *user) DeviceLookup(w http.ResponseWriter, r *http.Request) {
	...
	if err := header.Validate(); err != nil {
		u.logger.Error(r.Context(), "invalid device look up request", zap.Error(err))
		response.SendErrorResponse(w, err)
		return
	}
...
func (u *user) PreLogin(w http.ResponseWriter, r *http.Request) {
	...
	if err := header.Validate(); err != nil {
		u.logger.Error(r.Context(), "invalid input provided for pre login reqquest", zap.Error(err))
		response.SendErrorResponse(w, err)
		return
	}
	...
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		u.logger.Error(r.Context(), "failed to decode pre login request", zap.Error(err))
		response.SendErrorResponse(w, errors.ErrInvalidData)
		return
	}

	if err := req.Validate(); err != nil {
		u.logger.Error(r.Context(), "invalid input provided for pre login request", zap.Error(err))
		response.SendErrorResponse(w, err)
		return
	}

	res, err := u.userService.PreLogin(r.Context(), header, req.Phone)
	if err != nil {
		response.SendErrorResponse(w, err)
		return
	}
...
func (u *user) ChangePin(w http.ResponseWriter, r *http.Request) {
	...
	if err := req.Validate(); err != nil {
		u.logger.Error(r.Context(), "invalid input provided to change pin", zap.Error(err))
		response.SendErrorResponse(w, err)
		return
	}
...
func (u *user) CheckPin(w http.ResponseWriter, r *http.Request) {
	...
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		u.logger.Error(r.Context(), "failed to decode pin strength request", zap.Error(err))
		response.SendErrorResponse(w, errors.ErrInvalidData)
		return
	}
...
func (u *user) CompleteRegistration(w http.ResponseWriter, r *http.Request) {
	...
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		u.logger.Error(r.Context(), "failed to decode complete reqgistration request", zap.Error(err))
		response.SendErrorResponse(w, errors.ErrInvalidData)
		return
	}
	...
	if err := req.Validate(); err != nil {
		u.logger.Error(r.Context(), "invalid input provided to complete registration", zap.Error(err))
		response.SendErrorResponse(w, err)
		return
	}
...
func (u *user) ForgetPinSendOtp(w http.ResponseWriter, r *http.Request) {
	...
	header := common.ExtractHeader(r)
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		u.logger.Error(r.Context(), "failed to decode forget pin request", zap.Error(err))
		response.SendErrorResponse(w, errors.ErrInvalidData)
		return
	}

	if err := req.Validate(); err != nil {
		u.logger.Error(r.Context(), "invalid input for forget pin provided", zap.Error(err))
		response.SendErrorResponse(w, err)
		return
	}
...
func (u *user) Login(w http.ResponseWriter, r *http.Request) {
	...
	if header.DeviceUUID == "" {
		u.logger.Error(r.Context(), "device UUID is required")
	...
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		u.logger.Error(r.Context(), "failed to decode login request", zap.Error(err))
		response.SendErrorResponse(w, errors.ErrInvalidData)
		return
	}

	if err := req.Validate(); err != nil {
		u.logger.Error(r.Context(), "invalid input provided to login request", zap.Error(err))
		response.SendErrorResponse(w, err)
		return
	}
...
func (u *user) ResetPin(w http.ResponseWriter, r *http.Request) {
	...
	if err := req.Validate(); err != nil {
		u.logger.Error(r.Context(), "invalid input provided to reset pin request", zap.Error(err))
		response.SendErrorResponse(w, err)
		return
	}
...
func (u *user) ResetPinWithToken(w http.ResponseWriter, r *http.Request) {
	...
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		u.logger.Error(r.Context(), "failed to decode reset pin with token request", zap.Error(err))
		response.SendErrorResponse(w, errors.ErrInvalidData)
		return
	}
...
func (u *user) SetPin(w http.ResponseWriter, r *http.Request) {
	...
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		u.logger.Error(r.Context(), "failed to decode set pin request", zap.Error(err))
		response.SendErrorResponse(w, errors.ErrInvalidData)
		return
	}
	...
	if err := req.Validate(); err != nil {
		u.logger.Error(r.Context(), "invalid input provided to set pin request", zap.Error(err))
		response.SendErrorResponse(w, err)
		return
	}
...
func (u *user) UpdateProfilePicture(w http.ResponseWriter, r *http.Request) {
	...
	if err := r.ParseMultipartForm(2 << 20); err != nil {
		u.logger.Error(r.Context(), "failed to parse form data", zap.Error(err))
		response.SendErrorResponse(w, errors.ErrInvalidData)
		return
	}
	...
	if err != nil {
		u.logger.Error(r.Context(), "failed to get profile picture", zap.Error(err))
		response.SendErrorResponse(w, errors.ErrInvalidData)
		return
	}
	defer file.Close()
	...
	if err := req.Validate(); err != nil {
		u.logger.Error(r.Context(), "invalid request", zap.Error(err))
		response.SendErrorResponse(w, errors.ErrInvalidData)
		return
	}
...
func (u *user) UpdateProfileTheme(w http.ResponseWriter, r *http.Request) {
	...
	if err := req.Validate(); err != nil {
		u.logger.Error(r.Context(), "invalid request for update profile theme", zap.Error(err))
		response.SendErrorResponse(w, errors.ErrInvalidData)
		return
	}
...
func (u *user) VerifyEmailOTP(w http.ResponseWriter, r *http.Request) {
	...
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		u.logger.Error(r.Context(), "failed to decode otp verification request", zap.Error(err))
		response.SendErrorResponse(w, errors.ErrInvalidData)
		return
	}
	req.UserID = userInfo.UserID
...
func (u *user) VerifyForgetPinOtp(w http.ResponseWriter, r *http.Request) {
	...
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		u.logger.Error(r.Context(), "failed to decode verify foget pin request", zap.Error(err))
		response.SendErrorResponse(w, errors.ErrBadRequest)
		return
	}

	if err := req.Validate(); err != nil {
		u.logger.Error(r.Context(), "invalid input provided to verify forget pin request", zap.Error(err))
		response.SendErrorResponse(w, err)
		return
	}
