...
// versions:
//   sqlc v1.29.0
// source: bank_vault_products.sql
...
//   TO_CHAR(early_unlock_fee_bps) as early_unlock_fee_bps,
//   is_active,
//   created_at,
//   updated_at,
//   deleted_at,
...
// 	i.EarlyUnlockFeeBps, _ = decimal.NewFromString(earlyUnlockFeeBps_num.String())

// 	if err == sql.ErrNoRows {
// 		return BankVaultProduct{}, fmt.Errorf("NO_BANK_PRODUCT_FOUND")
// 	}
...
// 		l.EarlyUnlockFeeBps, _ = decimal.NewFromString(earlyUnlockFeeBps_num.String())
