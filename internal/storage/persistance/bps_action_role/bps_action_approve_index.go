...
func (r *BPSActionApproveIndexRepository) SaveIndices(ctx context.Context, indices []model.BPSActionApproveIndex) error {
...
func (r *BPSActionApproveIndexRepository) SyncIndices(ctx context.Context, oldActionName string, newIndices []model.BPSActionApproveIndex) error {
	...
	var oldIndices []model.BPSActionApproveIndex
	if err := cursor.All(ctx, &oldIndices); err != nil {
		return err
	}

	oldMap := make(map[string]model.BPSActionApproveIndex)
