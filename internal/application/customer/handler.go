...
type ApplicationService interface {
	GetCustomersDeatil(ctx context.Context, kyc_level int, filterParams *constant.Filter) (*common_util.PaginatedResponse[[]*member.User], error)
...
func (c CustomerHandler) GetCustomersDeatil(ctx context.Context, kyc_level int, filterParams *constant.Filter) (*common_util.PaginatedResponse[[]*member.User], error) {
...
func (c CustomerHandler) GetBlockedCustomer(ctx context.Context, filterParams *constant.Filter) (*common_util.PaginatedResponse[[]*member.User], error) {
