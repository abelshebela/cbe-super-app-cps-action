...
import (
	...
	"gitlab.com/bersufekadgetachew/cbe-super-app-cps-action/internal/domain/cps_user_maker/services"
)
...
func (h *Handler) CreateUserRequest(ctx context.Context, user action.CPSUser, maker action.User) error {
    return h.service.CreateUserRequest(ctx, user, maker)
}

func (h *Handler) UpdateUserRequest(ctx context.Context, updated action.CPSUser, maker action.User) error {
...
func (h *Handler) GetPendingUserActions(ctx context.Context) ([]action.CPSAction, error) {
