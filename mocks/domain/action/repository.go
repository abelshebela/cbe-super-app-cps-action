...
func (mr *MockRepositoryMockRecorder) FetchPendingActionsByUniqueID(ctx, uniqueID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FetchPendingActionsByUniqueID", reflect.TypeOf((*MockRepository)(nil).FetchPendingActionsByUniqueID), ctx, uniqueID)
}
