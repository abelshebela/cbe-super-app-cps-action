...
const file_topup_proto_rawDesc = "" +
	"\n" +
	"\vtopup.proto\x12\x05topup\x1a\x1fgoogle/protobuf/timestamp.proto\"\x0e\n" +
	...
	"\fTopupService\x128\n" +
	"\vGetAllTopup\x12\x13.topup.TopupRequest\x1a\x14.topup.TopupResponseBBZ@github.com/abelshebela/cbe-super-app-cps-action/grpc/topup;topupb\x06proto3"
...
var file_topup_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
