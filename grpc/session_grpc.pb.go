...
const (
	...
	SessionService_HealthCheck_FullMethodName   = "/session.SessionService/HealthCheck"
)
...
//
// SessionService provides gRPC endpoints for session management
type SessionServiceClient interface {
	// CreateSession creates a new payment session
	CreateSession(ctx context.Context, in *CreateSessionRequest, opts ...grpc.CallOption) (*CreateSessionResponse, error)
	// UpdateSession updates an existing session after client validation
