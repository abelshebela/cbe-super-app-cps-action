...
const file_proto_wallet_proto_rawDesc = "" +
	"\n" +
	"\x12proto/wallet.proto\x12\x06wallet\"\x91\x01\n" +
	"\x06Wallet\x12\x0e\n" +
	...
	"\n" +
	"is_deleted\x18\x06 \x01(\bR\tisDeleted\"0\n" +
	"\x04docs\x12(\n" +
...
var file_proto_wallet_proto_goTypes = []any{
	...
	(*Docs)(nil),                 // 1: wallet.docs
	(*GetWalletRequest)(nil),     // 2: wallet.GetWalletRequest
	(*GetAllWalletRequest)(nil),  // 3: wallet.GetAllWalletRequest
	(*GetWalletResponse)(nil),    // 4: wallet.GetWalletResponse
	(*Meta)(nil),                 // 5: wallet.Meta
	(*GetAllWalletResponse)(nil), // 6: wallet.GetAllWalletResponse
}
var file_proto_wallet_proto_depIdxs = []int32{
	0, // 0: wallet.docs.wallets:type_name -> wallet.Wallet
	0, // 1: wallet.GetWalletResponse.wallet:type_name -> wallet.Wallet
	0, // 2: wallet.GetAllWalletResponse.wallets:type_name -> wallet.Wallet
	5, // 3: wallet.GetAllWalletResponse.metadata:type_name -> wallet.Meta
	2, // 4: wallet.WalletService.GetWallet:input_type -> wallet.GetWalletRequest
	3, // 5: wallet.WalletService.GetAllWallet:input_type -> wallet.GetAllWalletRequest
	4, // 6: wallet.WalletService.GetWallet:output_type -> wallet.GetWalletResponse
	6, // 7: wallet.WalletService.GetAllWallet:output_type -> wallet.GetAllWalletResponse
