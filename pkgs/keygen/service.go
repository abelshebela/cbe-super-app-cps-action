...
func (g *Ed25519KeyGen) GenerateKeyPair() (KeyPair, error) {
	...
	if err != nil {
		...
		return KeyPair{}, fmt.Errorf(localization.ErrorUnhandledServer.Code)
	}
	keyPair := KeyPair{
...
func (g *Ed25519KeyGen) Sign(data []byte, privateKey string) ([]byte, error) {
	...
	if err != nil {
		...
		return nil, fmt.Errorf(localization.ErrorUnhandledServer.Code)
	}
...
func (g *Ed25519KeyGen) Verify(data, signature []byte, publicKey string) (bool, error) {
	...
	if err != nil {
		...
		return false, fmt.Errorf(localization.ErrorUnhandledServer.Code)
	}
