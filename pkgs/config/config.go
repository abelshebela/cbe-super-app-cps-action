...
type VaultConfig struct {
	...
	OtpWaitTime                   string `mapstructure:"OTP_WAITING_TIME"`
	GoEnv                         string `mapstructure:"GO_ENV"`
	CONFIG_IP                     string `mapstructure:"CONFIG_IP"`
	CONFIG_PORT_LDAP_NOTIFICATION string `mapstructure:"CONFIG_PORT_LDAP_NOTIFICATION"`
}
