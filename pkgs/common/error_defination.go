...
var DefineError = ErrorDefinitions{
	...
	AccountBlock: ErrorGroup{
		"PENDING_ACTION_ALREADY_EXISTS": {
			Code:    "ACC_BLK_001",
			Message: "pending disable action already exists for this branch and maker",
		},
		"DEPARTMENT_NOT_FOUND_CONTEXT": {
			Code:    "ACC_BLK_002",
			Message: "Department not found in the context ",
		},
