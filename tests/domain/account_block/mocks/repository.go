...
//
//	mockgen -source=internal/domain/account_block/repository.go -destination=tests/account_block/mocks/repository.go -package=mocks
//
...
func (mr *MockAccountBlockRepoMockRecorder) ApproveBlockCity(ctx, actionID, approve, reason, checker any) *gomock.Call {
...
func (mr *MockAccountBlockRepoMockRecorder) ApproveBlockDistrict(ctx, actionID, approve, reason, checker any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAccountBlockRepoMockRecorder) ApproveBlockUser(ctx, actionID, approve, reason, checker any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAccountBlockRepoMockRecorder) ApproveBulkBranchesDisable(ctx, actionID, approve, reason any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAccountBlockRepoMockRecorder) ApproveRegionBlock(ctx, actionID, approve, reason, checker any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAccountBlockRepoMockRecorder) ApproveSingleBranchDisable(ctx, actionID, approve, reason any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAccountBlockRepoMockRecorder) BlockCity(ctx, cityCode, maker any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAccountBlockRepoMockRecorder) BlockDistrict(ctx, districtCode, maker any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAccountBlockRepoMockRecorder) BlockRegion(ctx, regionCode, maker any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAccountBlockRepoMockRecorder) BlockUser(ctx, userID, maker any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAccountBlockRepoMockRecorder) DisableMultipleBranches(ctx, branches, maker any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAccountBlockRepoMockRecorder) DisableSingleBranch(ctx, branch, maker any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockAccountBlockRepo) FilterMultipleBranches(ctx context.Context, region, district string, filterParams *utils0.Filter) (*utils.PaginatedResponse[[]*model.Branch], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FilterMultipleBranches", ctx, region, district, filterParams)
	ret0, _ := ret[0].(*utils.PaginatedResponse[[]*model.Branch])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// FilterMultipleBranches indicates an expected call of FilterMultipleBranches.
func (mr *MockAccountBlockRepoMockRecorder) FilterMultipleBranches(ctx, region, district, filterParams any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FilterMultipleBranches", reflect.TypeOf((*MockAccountBlockRepo)(nil).FilterMultipleBranches), ctx, region, district, filterParams)
}

// FilterSingleBranches mocks base method.
func (m *MockAccountBlockRepo) FilterSingleBranches(ctx context.Context, region, district string, filterParams *utils0.Filter) (*utils.PaginatedResponse[[]*model.Branch], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FilterSingleBranches", ctx, region, district, filterParams)
	ret0, _ := ret[0].(*utils.PaginatedResponse[[]*model.Branch])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockAccountBlockRepoMockRecorder) FilterSingleBranches(ctx, region, district, filterParams any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FilterSingleBranches", reflect.TypeOf((*MockAccountBlockRepo)(nil).FilterSingleBranches), ctx, region, district, filterParams)
}
...
func (mr *MockAccountBlockRepoMockRecorder) GetBranchByCode(ctx, branchCode any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAccountBlockRepoMockRecorder) GetCityByCode(ctx, cityCode any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAccountBlockRepoMockRecorder) GetDistrictByCode(ctx, districtCode any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAccountBlockRepoMockRecorder) GetRegionByCode(ctx, regionCode any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAccountBlockRepoMockRecorder) GetUserByPhone(ctx, phoneNumber, maker any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAccountBlockRepoMockRecorder) UpdateRegion(ctx, region any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
