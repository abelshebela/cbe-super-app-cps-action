...
import (
	...
	access_list_segmentation_service "github.com/abelshebela/cbe-super-app-cps-action/internal/service/access_list_segmentation"
	accountblock "github.com/abelshebela/cbe-super-app-cps-action/internal/service/account_block"
	ap_svc "github.com/abelshebela/cbe-super-app-cps-action/internal/service/account_product"
	apc_svc "github.com/abelshebela/cbe-super-app-cps-action/internal/service/account_product_category"
	account_sub_type_svc "github.com/abelshebela/cbe-super-app-cps-action/internal/service/account_sub_type"
	accountvalidation "github.com/abelshebela/cbe-super-app-cps-action/internal/service/account_validation"
	advert "github.com/abelshebela/cbe-super-app-cps-action/internal/service/ad"
	amount_based_auth "github.com/abelshebela/cbe-super-app-cps-action/internal/service/amount_based_auth"
	bankService "github.com/abelshebela/cbe-super-app-cps-action/internal/service/bank"
	bps_action_service "github.com/abelshebela/cbe-super-app-cps-action/internal/service/bps_action"
	bpsuser "github.com/abelshebela/cbe-super-app-cps-action/internal/service/bps_user"
	event_merchant_service "github.com/abelshebela/cbe-super-app-cps-action/internal/service/event_merchant"
	logistics_merchant_service "github.com/abelshebela/cbe-super-app-cps-action/internal/service/logistics_merchant"
	"github.com/abelshebela/cbe-super-app-cps-action/internal/service/media"
	newscategory_service "github.com/abelshebela/cbe-super-app-cps-action/internal/service/news_category"
	newstag_service "github.com/abelshebela/cbe-super-app-cps-action/internal/service/news_tag"
	role_delegation_service "github.com/abelshebela/cbe-super-app-cps-action/internal/service/role_delegation"
	tac_svc "github.com/abelshebela/cbe-super-app-cps-action/internal/service/term_and_condition"
	token_provider_svc "github.com/abelshebela/cbe-super-app-cps-action/internal/service/token_provider"
	...
	vault_category "github.com/abelshebela/cbe-super-app-cps-action/internal/service/vault"

	bps_action_role_service "github.com/abelshebela/cbe-super-app-cps-action/internal/service/bps_action_role"
	budgetCategorySvc "github.com/abelshebela/cbe-super-app-cps-action/internal/service/budget_category"
	bulk_service "github.com/abelshebela/cbe-super-app-cps-action/internal/service/bulk"
	cpsaction "github.com/abelshebela/cbe-super-app-cps-action/internal/service/cps_action"
	cpsusersvc "github.com/abelshebela/cbe-super-app-cps-action/internal/service/cps_user"
	customer "github.com/abelshebela/cbe-super-app-cps-action/internal/service/customer"
	"github.com/abelshebela/cbe-super-app-cps-action/internal/service/department"
	deviceversion "github.com/abelshebela/cbe-super-app-cps-action/internal/service/device_version"
	"github.com/abelshebela/cbe-super-app-cps-action/internal/service/event"
	miniapp "github.com/abelshebela/cbe-super-app-cps-action/internal/service/mini_app"

	"github.com/abelshebela/cbe-super-app-cps-action/internal/storage/external_call/account_lookup"

	avatar "github.com/abelshebela/cbe-super-app-cps-action/internal/service/avatar"
	ecommerce_merchant "github.com/abelshebela/cbe-super-app-cps-action/internal/service/ecommerce-merchant"
	"github.com/abelshebela/cbe-super-app-cps-action/internal/service/fayda"
	feedback "github.com/abelshebela/cbe-super-app-cps-action/internal/service/feedback"
	"github.com/abelshebela/cbe-super-app-cps-action/internal/service/hq"
	password "github.com/abelshebela/cbe-super-app-cps-action/internal/service/password_rule"
	permission "github.com/abelshebela/cbe-super-app-cps-action/internal/service/permission"
	portalcard "github.com/abelshebela/cbe-super-app-cps-action/internal/service/portal_card"

	cps_action_role_service "github.com/abelshebela/cbe-super-app-cps-action/internal/service/cps_action_role"
	customer_group "github.com/abelshebela/cbe-super-app-cps-action/internal/service/customer_group"
	kyc_service "github.com/abelshebela/cbe-super-app-cps-action/internal/service/customer_kyc"
	customer_segmentation "github.com/abelshebela/cbe-super-app-cps-action/internal/service/customer_segmentation"
	donation "github.com/abelshebela/cbe-super-app-cps-action/internal/service/donation"
	donation_category "github.com/abelshebela/cbe-super-app-cps-action/internal/service/donation_category"
	donation_company "github.com/abelshebela/cbe-super-app-cps-action/internal/service/donation_company"
	encryption_service "github.com/abelshebela/cbe-super-app-cps-action/internal/service/encryption"
	job_role "github.com/abelshebela/cbe-super-app-cps-action/internal/service/job_role"
	kycsvc "github.com/abelshebela/cbe-super-app-cps-action/internal/service/kyc_verifier"
	"github.com/abelshebela/cbe-super-app-cps-action/internal/service/notification"
	"github.com/abelshebela/cbe-super-app-cps-action/internal/service/roles"
	services_svc "github.com/abelshebela/cbe-super-app-cps-action/internal/service/services"
	sitota_service "github.com/abelshebela/cbe-super-app-cps-action/internal/service/sitota"
	superapp_role "github.com/abelshebela/cbe-super-app-cps-action/internal/service/superapp_role"
	"github.com/abelshebela/cbe-super-app-cps-action/internal/service/topup"
	transaction_service "github.com/abelshebela/cbe-super-app-cps-action/internal/service/transaction"
	"github.com/abelshebela/cbe-super-app-cps-action/internal/service/unlink"
	ussd_merchant "github.com/abelshebela/cbe-super-app-cps-action/internal/service/ussd_merchant"
	survey_sampling_svc "github.com/abelshebela/cbe-super-app-cps-action/internal/service/survey_sampling"
	utility_svc "github.com/abelshebela/cbe-super-app-cps-action/internal/service/utility"
	"github.com/abelshebela/cbe-super-app-cps-action/internal/service/wallet"
	...
	bank_cache "gitlab.com/bersufekadgetachew/cbe-super-app-shared/shared/catch/bank"
...
func InitServiceLayer(mongoClient *mongo.Client, persistence persistance.Persistence, oracle OraclePersistence, coreInterface core.CBECoreAPIInterface,
	...
	cfg *config.VaultConfig, minioClient *s3.Client, redis storage.RedisRepository, smsService *lib.NotificationStore, notificationProducer *kafka.NotificationProducer,
	...
	vaultTransactionService := transaction_service.NewVaultTransactionService(nil, oracle.SuperAppRole, persistence.TransactionLimitPersistence, oracle.Customer, coreInterface, logger)
	...
	accessListSegmentationService := access_list_segmentation_service.NewAccessListSegmentationService(oracle.AccessListSegmentaion, nil, oracle.AccessListOracle, persistence.AccountBlockPersistence, oracle.Customer, persistence.CPSRoles, logger)
	...
	bank_service = bankService.NewBankService(logger, persistence.BankPersistence, oracle.BankOracle, cpsActionService, bankCache, minioClient, minioPubUrl, cfg, cfg.S3BucketName)
	...
	accessListSegmentationService = access_list_segmentation_service.NewAccessListSegmentationService(oracle.AccessListSegmentaion, cpsActionService, oracle.AccessListOracle, oracle.AccountBlock, oracle.Customer, oracle.NewCPSRolesStorage, logger)
