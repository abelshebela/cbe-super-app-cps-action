...
import (
	...
	access_list_oracle "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/access_list_oracle"
	access_list_segmentation_oracle "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/access_list_segmentation/oracle"
	account_block_repo "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/account_block"
	ap_oracle "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/account_product/oracle"
	apc_oracle "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/account_product_category/oracle"
	account_sub_type_oracle "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/account_sub_type"
	amount_based_auth_oracle "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/amount_based_auth_oracle"
	"github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/bank/gen/sqlc"
	budget_category_oracle "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/budget_category_oracle"
	cpsroles "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/cps_roles"
	customer_oracle "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/customer/oracle"
	customergroup "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/customer_group"
	customer_kyc "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/customer_kyc"
	customersegmentaion "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/customer_segmentaion"
	donation_oracle "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/donation/oracle"
	donation_category_oracle "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/donation_category/oracle"
	donation_company_oracle "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/donation_company/oracle"
	ecommerce_merchant "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/ecommerce_merchant"
	event_oracle "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/event_merchant_oracle"
	logistics_merchant_oracle "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/logistics_merchant/oracle"
	mini_app_repo "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/mini_app/oracle"
	services_repo "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/services"
	"github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/sitota"
	superapprole "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/superapp_role"
	tac_oracle "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/term_and_condition/oracle"
	"github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/ussd_merchant"
	vaultCategory "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/vault"
	wallet_oracle "github.com/abelshebela/cbe-super-app-cps-action/internal/storage/persistance/wallet/oracle"
